<div class="grid w-full grid-cols-1 space-y-4">
    <div class="space-y-4">
        <x-bread-crumb :inp="['name' => 'Settings', 'url' => 'admin/settings']" />
        ...
        <div
            ...
            <div class="w-full overflow-x-auto">
                <form wire:submit.prevent="updateSchoolInfo" class="w-full">
                    <table class="w-full border-collapse oveflow-x-auto">
                        <tr class="flex flex-col w-full min-w-full border divide-x md:flex-row lg:flex-none">
                            {{-- <td class="p-2 border">
