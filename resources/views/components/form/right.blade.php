<div x-cloak class="w-full h-screen p-0 bg-opacity-80 bg-black fixed inset-0 z-50"
    x-data="{ form: @entangle('form').defer }" x-show="form">
    <div @click.away="form = false"
        class="fixed top-0 right-0 z-60 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800">
        <h5 id="drawer-label"
        ...
        <button @click="form = false" type="button"
