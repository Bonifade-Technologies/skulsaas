<div x-cloak x-data="{ confirm: @entangle('confirm').defer }" x-show="confirm"
    class="fixed left-0 right-0 z-50 items-center justify-center overflow-x-hidden bg-opacity-75 top-4 md:inset-0 flex bg-black">
